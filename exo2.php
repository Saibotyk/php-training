...
<body class="dark-template">
    <div class="container">
            ...
            <div class="exercice-sandbox">
                ...
                echo "<ul>";
                    foreach($fruits as $fruit) {
                        ...
                        echo "<li>$fruit avec ".strlen($fruit)." lettres</li>";
                    };
                    echo "</ul>";
                    ?>
            </div>
        ...
        <section class="exercice">
            ...
            <div class="exercice-sandbox">
                    <?php
                    $breakfast = str_replace($fruits[2], $fruits[5], $breakfast);
                    $breakfast = str_replace($fruits[1], "mangue", $breakfast);
                    echo "<p> $breakfast </p>";
                    ?>
            </div>
        </section>
